...
@section('page_title', 'Gestión de Incidencias')
            ...
            <div class="panel panel-bordered">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="page-title">
                                <i class="voyager-warning"></i> Gestión de Incidencias
                            </h1>
                        </div>
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" id="search" class="form-control" placeholder="Buscar por nombre de empleado o motivo...">
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="voyager-trash"></i> ¿Estás seguro de que quieres eliminar esta incidencia?</h4>
            </div>
            <div class="modal-footer">
                <form id="delete_form" method="POST">
                    @csrf
                    @method('DELETE')
                    <input type="submit" class="btn btn-danger pull-right delete-confirm" value="Sí, ¡Bórrala!">
                </form>
